    ...
    public function reg_earning($userid, $sponsor, $packageid, $need_topup = true, $qty = 1)
    {
        ...
        if ($get_topup > "0" or $need_topup === false):
            ...
            if ($data->direct_income > "0.00" && trim($sponsor) !== '') {
                ...
                $refral_income=$get_topup * ($data->direct_income/100);
                $this->pay_earning($sponsor, $userid, 'Referral Income', $refral_income);
            }
            ...
            if (trim($data->level_income) !== "") {
                ...
                foreach ($ex as $e) {
                    ...
                    if ($pay_sponsor > 0 && $e > 0) {
                        $level_inc=$get_topup *($e/100);
                        $this->pay_earning($pay_sponsor, $userid, 'Level Income', $level_inc);
                    }
                    $i++;
                }
            }
