            ...
            <div class="navbar-collapse nav-responsive-disabled">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        ...
                        <a style="padding-left:120px !important;" href="<?php echo base_url('member') ?>">
                       
                        Welcome, <?php echo $this->session->name ?>(<?php echo config_item('IT_EXT') . $this->session->user_id ?>)</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right hidden-xs">
                    ...
                    <li class="dropdown dropdown-usermenu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            ...
                            <li><a href="<?php echo site_url('member/holding') ?>"><i class="fa fa-user"></i> Holding</a>
                            </li>
                            <li class="divider"></li>
        ...
        <aside id="aside" class="ui-aside">
            <ul class="nav" ui-nav>
                <li class=" text-center">
                    <?php
                    $me=$this->db->select('photo')->from('member')->where('id',$this->session->user_id)->get()->row_array();
                    ?>
                    <a href="<?php echo base_url()?>Member/profile_image" title="Click Here To Edit Profile Image">
                        <img src="<?php echo ($me['photo'])?base_url().$me['photo']:base_url()."uploads/member_image/no_img.jpg"; ?>" alt="Image" style="max-width: 30%; border-radius:50%;" >
                ...
                <li>
                    ...
                    <ul class="nav nav-sub">
                        ...
                        $mem = $this->db->select('status')->where('id', $this->session->user_id)->get('member')->row_array();

                        if ($mem['status'] == 'Active') : ?>
                            <li><a href="<?php echo site_url('member/holding') ?>"><span>My Holding</span></a></li>
                            <li><a href="<?php echo site_url('member/close_account') ?>"><span>Close Account</span></a></li>
                        <?php endif; ?>
