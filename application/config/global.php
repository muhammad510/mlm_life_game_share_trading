...
$config['company_name'] = "Life Game Share Trading Marketing Pvt. Ltd";
$config['company_address'] = "Motilal complex u block , 3rd floor,<br>Saket, South Delhi, PinCode - 110017";
$config['company_mobile'] = "8877225887";
$config['email'] = " lifegamesharemarketing@gmail.com";
$config['ID_EXT'] = 'LST'; # ID Extension eg: DM1001
