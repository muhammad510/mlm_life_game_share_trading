...
class Site extends CI_Controller
{
    ...
    {
        $layout['page_title']="Trading";
        $layout['layout'] = "trading.php";
         $this->load->view('theme/default/base', $layout);
    ...
    {
        $layout['page_title']="share sell";
        $layout['layout'] = "share_sell.php";
         $this->load->view('theme/default/base', $layout);
    ...
    {
        $layout['page_title']="services";
        $layout['layout'] = "services.php";
         $this->load->view('theme/default/base', $layout);
    ...
    function email_contact()
    {
        ...
        $to = "lifegamesharemarketing@gmail.com";
        $subject = "Enquiry From LifeGame.com ";
        $headers =  'MIME-Version: 1.0' . "\r\n";
        $headers .= 'From: LifeGame.com' . "\r\n";
    ...
    {
        $layout['page_title']="Business_plan";
    ...
    public function tc()
    {
        $layout['page_title']="Term and Condition";
    ...
    public function register()
    {
        ...
        if ($this->form_validation->run() !== FALSE && !empty($this->db_model->select('name', 'member', array('id' => $this->input->post('sponsor')))) && !empty($this->db_model->select('name', 'member', array('id' => $this->input->post('position'))))) {
            //   echo "<pre>";
    ...
    public function email($email,$name,$msg)
    {
